...
const agents = [
  {
    ...
    glyph: '⌬',
    name: 'mind',
    sub: 'Kairos · search intelligence',
    desc: 'Ask anything. She synthesizes the web into a single cited answer.',
    status: 'live',
  },
  {
    href: '/speak',
    glyph: '◎',
    name: 'speak',
    sub: 'HexBot · conversational layer',
    desc: 'Talk to her directly. HexBot is her primary voice in conversation.',
    status: 'soon',
  },
  {
    href: '/see',
